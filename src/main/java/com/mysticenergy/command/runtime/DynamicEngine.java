...
public class DynamicEngine {
    ...
    public Class javaCodetoMemory(String fullClassName, String javaCode) throws Exception {
        ...
        System.out.println("javaCodeToMemory use:"+(end-start)+"ms");
        return clazz;
    }
    ...
    public Object javaCodeToObject(String fullClassName, String javaCode) throws Exception {
        Class clazz = javaCodetoMemory(fullClassName,javaCode);
        return clazz.newInstance();
    }

    public Class getClassForName(String name) throws ClassNotFoundException {
        return dynamicClassLoader.findClassByClassName(name);
    }
