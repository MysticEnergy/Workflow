...
public class CommandHelper {
     ...
     * @throws Exception
     */
    public Class compile(Node node) throws Exception {
        ...
        InputStream in = new StringBufferInputStream(realCode);
    ...
    public void run(Node node) throws Exception {
        String fullClassName = fullPreClassName + node.get_id() + tailClassName;
        Class clazz = DynamicEngine.getInstance().getDynamicClassLoader().loadClass(fullClassName);
